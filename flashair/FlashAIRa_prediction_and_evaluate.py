...
class Config:
    ...
    # 数据库路径 (data文件夹与flashair同级)
    DB_PATH = _CURRENT_DIR.parent / 'data' / 'FlashAIR-QM9d.db'
    
    # 工作目录 (flashair/V0.8.8/)
    ...
    # 波数路径 (flashair/V0.8.8/data/wavenumber_550-3846-4.npy)
    WAVENUMBERS_PATH = DATA_DIR / 'wavenumber_550-3846-4.npy'
